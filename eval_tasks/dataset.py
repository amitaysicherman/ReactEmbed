...
def get_dataloaders(task_name, mol_emd, protein_emd, batch_size):
    ...
    train_loader = DataLoader(TaskPrepDataset(x1_train, x2_train, labels_train), batch_size=batch_size, shuffle=True,
                              drop_last=False)
    valid_loader = DataLoader(TaskPrepDataset(x1_valid, x2_valid, labels_valid), batch_size=batch_size, shuffle=True,
                              drop_last=False)
    test_loader = DataLoader(TaskPrepDataset(x1_test, x2_test, labels_test), batch_size=batch_size, shuffle=True,
                             drop_last=False)
